...
#import <Masonry.h>
@interface QGCodeViewController ()<QGCollectionMenuDataSource,QGCollectionMenuDelegate>
@property (strong, nonatomic) QGCollectionMenu *menu;
@end

@implementation QGCodeViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.view.backgroundColor = [UIColor lightGrayColor];
    self.menu = [[[NSBundle mainBundle] loadNibNamed:@"QGCollectionMenu" owner:self options:nil] lastObject];
    ...
    self.menu.lineHeight = 2;
    self.menu.titleCollectionLeftOrRightLayoutInset = 50;
    self.menu.lineInCenter = NO;
